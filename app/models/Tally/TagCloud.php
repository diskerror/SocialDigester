...
final class TagCloud extends AbstractTally
{
	 ...
	 * @return TypedArray
	 */
	public static function getHashtags(Collection $tweetsCollection, Config $config) : TypedArray
	{
	 ...
	 * @return TypedArray
	 */
	public static function getText(Collection $tweetsCollection, Config $config) : TypedArray
	{
		$tweets = $tweetsCollection->find([
			'text'       => ['$gt' => ''],
			'created_at' => ['$gt' => date('Y-m-d H:i:s', strtotime($config->window . ' seconds ago'))],
