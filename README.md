...
It requires PHP7, Phalcon, Composer, and the extension “Ds” available with PEAR. It is currently running on a VirtualBox instance with Debian 10, Nginx 1.14, PHP 7.4, MongoDB 4.4, and Phalcon 4.1.
